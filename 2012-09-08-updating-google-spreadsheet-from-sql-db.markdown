...
He gave me his skype contact only after he submitted his full answer!. ([Contractor profile](https://www.odesk.com/users/~018d29cf303df3dafd?sid=28001), [python script](sheet/sheet.py.txt), [mysql test](sheet/mysql_test.sql.txt), [pg test](sheet/pg_test.sql.txt), [readme](sheet/README.txt) ) When I asked Stanislav if he prefers Fixed Price or Hourly arrangements in the future he answered that he prefers Fixed Price because he keeps control of when / how much time he puts on projects. He also answered that he spend about an hour on the task.
* At 11:00am Monday I received the answrer from the ukranian contractor in [github](https://github.com/PProcks/db_to_spr) ([Contractor profile](https://www.odesk.com/users/~016153b9ccf6b75930]), [python script](sheet/script.py.txt), [settings.py](sheet/settings.py.txt) ). The answer was not perfect, it was not fully tested but still it was quite well written. The contractor definitely spend quite a lot more than a couple of hours coming up with it.
